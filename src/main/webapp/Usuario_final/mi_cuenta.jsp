                            ...
                            <div class="col-lg-6">
                                ...
                                style="width: 90%; max-width: 1400px; background-color: rgb(200, 200, 200) !important;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" id="celular_personal" name="celular_personal"  class="form-control" value="a20206311@pucp.edu.pe" readonly>
                                    </div>
                                    <div class="text-center mt-4 mb-3">
                                        <a href="editar_cuenta.html" class="btn btn-secondary">Editar</a>
                                      </div>
                                </form>
                            </div>
                        </div>
