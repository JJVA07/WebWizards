                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="donacionesTable" class="table table-bordered">
                                ...
                                <tr>
                                    <td>14 - 07 - 2024</td>
                                    <td>Donación económica</td>
                                    <td>Yape</td>
                                    <td>S/. 5.00</td>
                                    <td>
                                        <a href="<%= request.getContextPath() %>/donacion_detalle.jsp" class="btn inscribirse-btn d-inline-flex align-items-center" style="text-align: center; padding: 5px 10px; border-radius: 8px; background-color: transparent; text-decoration: none;">
                                ...
                                <tr>
                                    <td>20 - 08 - 2024</td>
                                    <td>Donación de comida</td>
                                    <td>Entrega presencial</td>
                                    <td>-</td>
                                    <td>
