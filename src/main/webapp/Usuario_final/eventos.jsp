...
<html lang="en">
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <!-- Contenedor para las 6 tarjetas alineadas -->
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                <!-- Tarjeta 1 -->
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos1.jpeg" class="card-img-top" alt="Evento 1" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title">Albergue perritos felices</h5>
                            <p class="card-text">Eventaso, PATATÓN 2024, NUESTRO PRIMER EVENTO!</p>
                            <div class="d-flex justify-content-center">
                                <a href="evento_albergue_perritos_felices.html" class="btn inscribirse-btn d-inline-flex align-items-center"
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos2.jpeg" class="card-img-top" alt="Evento 2" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title">Eventazo por fin de mes</h5>
                            <p class="card-text">Llévate 2 cachorros por el precio de 1, solo en Perro Vea.</p>
                            <div class="d-flex justify-content-center">
                                <a href="evento_albergue_perritos_felices.html" class="btn inscribirse-btn d-inline-flex align-items-center"
                                   style="text-align: center; padding: 5px 10px; border-radius: 8px; background-color: transparent; text-decoration: none;">
                                  <i class="fas fa-info-circle" style="color: #808080; font-size: 2rem; margin-right: 0.5rem;"></i>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos3.jpeg" class="card-img-top" alt="Evento 3" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title">Evento locos</h5>
                            <p class="card-text">Perros muy locos queriendo jugar en rambla.</p>
                            <div class="d-flex justify-content-center">
                                <a href="evento_albergue_perritos_felices.html" class="btn inscribirse-btn d-inline-flex align-items-center"
                                   style="text-align: center; padding: 5px 10px; border-radius: 8px; background-color: transparent; text-decoration: none;">
                                  <i class="fas fa-info-circle" style="color: #808080; font-size: 2rem; margin-right: 0.5rem;"></i>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos3.jpeg" class="card-img-top" alt="Evento 4" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title">Evento locos 2</h5>
                            <p class="card-text">Perros muy locos queriendo jugar en rambla.</p>
                            <div class="d-flex justify-content-center">
                                <a href="evento_albergue_perritos_felices.html" class="btn inscribirse-btn d-inline-flex align-items-center"
                                   style="text-align: center; padding: 5px 10px; border-radius: 8px; background-color: transparent; text-decoration: none;">
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos2.jpeg" class="card-img-top" alt="Evento 5" style="height: 200px; object-fit: cover;">
                        <div class="card-body d-flex flex-column align-items-center">
                            <h5 class="card-title">Eventazo por fin de mes 2</h5>
                            <p class="card-text">Llévate 2 cachorros por el precio de 1, solo en Perro Vea.</p>
                ...
                <div class="col d-flex justify-content-center">
                    <div class="card" style="width: 25rem;">
                        <img src="../assets/img/eventos2.jpeg" class="card-img-top" alt="Evento 6" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title">Eventazo por fin de mes 3</h5>
                            <p class="card-text">Llévate 3 cachorros por el precio de 2, solo en Perro Vea.</p>
                            <div class="d-flex justify-content-center">
                                <a href="evento_albergue_perritos_felices.html" class="btn inscribirse-btn d-inline-flex align-items-center"
                                   style="text-align: center; padding: 5px 10px; border-radius: 8px; background-color: transparent; text-decoration: none;">
                                  <i class="fas fa-info-circle" style="color: #808080; font-size: 2rem; margin-right: 0.5rem;"></i>
