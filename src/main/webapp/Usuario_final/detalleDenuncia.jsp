...
<head>
  ...
  <title>Detalles de Denuncia</title>
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid px-5">
        <h1 class="mt-5 text-center">Detalles de Denuncia</h1>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-7">
              <div class="card-body">
                ...
                <p class="card-text"><%= request.getAttribute("publicacion.tamano") %></p>
                <h5 class="card-title">Raza</h5>
                <p class="card-text"><%= request.getAttribute("publicacion.raza") %></p>
                ...
                <h5 class="card-title">Tipo de maltrato</h5>
                <p class="card-text"><%= request.getAttribute("publicacion.tipoMaltrato") %></p>
                <h5 class="card-title">Nombre del maltratador</h5>
                <p class="card-text"><%= request.getAttribute("publicacion.nombreMaltratador") %></p>
                <h5 class="card-title">Dirección del maltrato</h5>
                <p class="card-text"><%= request.getAttribute("publicacion.direccionMaltrato") %></p>
                <h5 class="card-title">Denuncia policial</h5>
                <p class="card-text"><%= (Boolean)request.getAttribute("publicacion.denunciaPolicial") ? "Sí" : "No" %></p>
              </div>
            </div>
          </div>
        </div>
