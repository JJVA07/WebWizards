                    ...
                    <div class="row justify-content-center mt-3">
                        <div class="col-sm-12 col-md-6 col-lg-4 d-flex justify-content-center">
                            <div class="card mb-4" style="width: 100%;">
                                    ...
                                    <img src="../assets/img/perro3.jpg" class="card-img-top img-fluid" alt="Perrito perdido" style="height: 200px; object-fit: cover;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="perrito_perdido_panchis.html" class="btn btn-aprove">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 d-flex justify-content-center">
                            <div class="card mb-4" style="width: 100%;">
                                <img src="../assets/img/denuncia_fer.jpg" class="card-img-top img-fluid" alt="Denuncia por maltrato" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
