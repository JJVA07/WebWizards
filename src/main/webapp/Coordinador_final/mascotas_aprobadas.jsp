...
<head>
    ...
    <title>Mascotas Aprobadas</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Mascotas Aprobadas</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Revisar Mascotas Aprobadas</li>
                </ol>

                <!-- Tabla de mascotas aprobadas -->
                <div class="card mb-4">
...
<script>
    ...
    // Datos de ejemplo de mascotas aprobadas
    const data = [
        { nombre: "Firulais", edad: 3, raza: "Labrador", tamaño: "Grande", contacto: "974769424" },
        { nombre: "Rex", edad: 2, raza: "Pastor Alemán", tamaño: "Grande", contacto: "912345678" },
        { nombre: "Dobby", edad: 1, raza: "Chihuahua", tamaño: "Pequeño", contacto: "987654321" },
        { nombre: "Toby", edad: 4, raza: "Bulldog", tamaño: "Mediano", contacto: "956123789" },
        { nombre: "Bruno", edad: 3, raza: "Boxer", tamaño: "Grande", contacto: "932178945" },
        { nombre: "Nina", edad: 1, raza: "Shih Tzu", tamaño: "Pequeño", contacto: "986543210" }
    ];
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton${index}">
                        <li>
                            <a class="dropdown-item" href="<%= request.getContextPath() %>/detalle_mascota_aprobada.jsp?index=${index}">Revisar</a>
                        </li>
