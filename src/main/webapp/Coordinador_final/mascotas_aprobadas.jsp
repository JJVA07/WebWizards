                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <%
                                    // Obtener la lista de publicaciones aprobadas del Servlet
                                    List<Publicacion> listaAprobadas = (List<Publicacion>) request.getAttribute("listaAprobadas");
                                    if (listaAprobadas != null && !listaAprobadas.isEmpty()) {
                                        for (int i = 0; i < listaAprobadas.size(); i++) {
                                            Publicacion publicacion = listaAprobadas.get(i);
                                %>
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<%= i %>">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="<%= request.getContextPath() %>/CoordinadorServlet?action=eliminarPublicacion&id=<%= publicacion.getIdPublicacion() %>">Eliminar</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                                ...
                                %>
                                <tr>
                                    <td colspan="6" class="text-center">No se encontraron mascotas aprobadas.</td>
                                </tr>
                                <%
                                    }
                                %>
