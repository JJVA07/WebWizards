            ...
            <div class="row">
              ...
              <div class="col-md-6 text-center">
                ...
                <div class="mt-4">
                  ...
                  <form action="<%= request.getContextPath() %>/CoordinadorServlet?action=actualizarComentario" method="post">
                    <input type="hidden" name="idPublicacion" value="<%= publicacion != null ? publicacion.getIdPublicacion() : "" %>">
                    <textarea name="comentario_coordinador" class="form-control mb-3" rows="3"
