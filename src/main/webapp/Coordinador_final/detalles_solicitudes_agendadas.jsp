        ...
        <div class="nav">
          ...
          <div class="collapse" id="collapseHogaresTemporales" aria-labelledby="headingFour" data-bs-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
              ...
              <a class="nav-link active" href="<%= request.getContextPath() %>/solicitudes_agendadas.jsp">Solicitudes Agendadas</a>
            </nav>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p><strong>Tiene mascotas:</strong> <%= request.getParameter("tieneMascotas") != null ? request.getParameter("tieneMascotas") : "No disponible" %></p>
              </div>
