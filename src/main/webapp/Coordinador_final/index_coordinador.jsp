            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 custom-post">
                        <a href="solicitud_de_hogares.jsp">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Se podrá aceptar o rechazar la solicitud del postulante. En caso el postulante sea aceptado, podrá aparecer en la página de hogares temporales disponibles en los albergues.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 custom-post">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Los hogares temporales permiten que las mascotas en necesidad tengan un lugar transitorio donde estar mientras son adoptadas.
                            </p>
                        </div>
                    </div>
                </div>
