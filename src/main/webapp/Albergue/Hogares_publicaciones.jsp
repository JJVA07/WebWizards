        ...
        <div class="container-fluid">
            ...
            <div class="container mt-4">
                <div class="row justify-content-center">
                    <!-- Generar tarjetas dinámicamente para cada hogar temporal -->
                    <c:forEach var="home" items="${homeList}">
                        <div class="col-md-4 mb-4">
                            <div class="card shadow bg-white">
                                <a href="${pageContext.request.contextPath}/HomeDetailsServlet?id=${home.id}">
                                    <img src="${pageContext.request.contextPath}/assets/img/${home.image}" alt="Imagen del Hogar" class="card-img-top img-fluid">
                                </a>
                                <div class="card-body text-center">
                                    <h5 class="card-title">${home.title}</h5>
                                    <p class="card-text">${home.description}</p>
                                    <div class="d-flex justify-content-center">
                                        <a href="${pageContext.request.contextPath}/HomeDetailsServlet?id=${home.id}" class="d-flex align-items-center text-decoration-none text-dark">
