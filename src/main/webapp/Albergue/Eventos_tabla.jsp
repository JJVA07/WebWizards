                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/EditEventServlet?id=${event.id}">Editar</a></li>
                                                    <li><a class="dropdown-item text-danger" href="${pageContext.request.contextPath}/DeleteEventServlet?id=${event.id}">Borrar</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
