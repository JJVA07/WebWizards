  ...
  <div id="layoutSidenav_content">
    <div class="container-fluid">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Hogar Benefico - Más Información</h1>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form action="Albergue.jsp" method="post" enctype="multipart/form-data" onsubmit="return mostrarAlerta(event)">
