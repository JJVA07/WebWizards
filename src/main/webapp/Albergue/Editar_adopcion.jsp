...
<head>
    ...
    <title>Publicacion - Adopción</title>
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"> Editar - Adopción</h1>
            </div>

            <div class="container mt-4">
                <div class="row justify-content-center">

                    <form id="editAdoptionForm" action="adopcion1.jsp" method="GET">
                        <div class="form-group mb-3">
                            <label for="nombreMascota">Nombre de la Mascota:</label>
                            <input type="text" id="nombreMascota" name="nombreMascota" class="form-control" value="Loula" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="Descripcion">Descripción:</label>
                            <input type="text" id="Descripcion" name="Descripcion" class="form-control" value="Descripción detallada de Loula" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="edad">Edad aproximada:</label>
                            <input type="text" id="edad" name="edad" class="form-control" value="4-5 años" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="raza">Tipo de Raza:</label>
                            <input type="text" id="raza" name="raza" class="form-control" value="Poodle" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="estado" name="estado" class="form-control" value="Disponible para adoptar" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="condiciones">Condiciones para Adoptar:</label>
                            <textarea id="condiciones" name="condiciones" class="form-control" rows="3" required>Debes ser mayor a 21 años, necesita ser esterilizada, tiempo para sus paseos diarios</textarea>
                        </div>
