...
<head>
    ...
    <title>Publicaciones - Donaciones</title>
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Publicaciones - Donaciones</h1>
            </div>

            <div class="container mt-4">
                <div class="row justify-content-center">
                    <%-- Ejemplo de tarjeta de donación --%>
                    <div class="col-md-4 mb-4">
                        <div class="card shadow bg-white">
                            <a href="donacion1.jsp">
                                <img src="<%= request.getContextPath() %>/assets/img/Donacion1.jpeg" alt="Imagen del Evento" class="card-img-top img-fluid">
                            </a>
                            <div class="card-body text-center">
                                <h5 class="card-title">¡Ayúdanos a salvar más vidas!</h5>
                                <p class="card-text">
                                    Nuestro albergue de perros necesita de tu apoyo para continuar brindando cuidado y amor a más de 27 perritos rescatados. Con tu donación, podemos asegurarles comida, refugio y la oportunidad de encontrar un hogar lleno de amor.
                                </p>
                                <div class="d-flex justify-content-center">
                                    <!-- Botón de edición -->
                                    <a href="Editar_donacion.jsp" class="me-5">
